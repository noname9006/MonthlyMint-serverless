...
// Unlimited Batch Mint Version - No limit on batch size
// This version removes the 20-token batch limit for flexibility
...
contract BotanixAmbassadorNFTUnlimited is ERC721URIStorage, Ownable {
    ...
    function _executeMint(
        ...
        userHasTier[to][levelName][yearValue][monthName] = true;
    ...
    function _update(
        ...
        if (from != address(0) && to != address(0)) {
            ...
            userHasTier[from][data.levelName][data.yearValue][data.monthName] = false;
            userHasTier[to][data.levelName][data.yearValue][data.monthName] = true;
    ...
    function hasUserTier(
        ...
        return userHasTier[user][levelName][yearValue][monthName];
    }
